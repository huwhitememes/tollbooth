# Base MCP x402 buyer article promo copy
...
https://agenttoll.dev/agenttoll-base-mcp-skill.md
...
Use `docs/blog/base-mcp-x402-agent-buyers.md` as the DEV Community source.
...
```text
https://agenttoll.dev/blog/og-base-mcp-x402-agent-buyers.png
```
